...
int i=st.executeUpdate("INSERT INTO logindetails(email,password) VALUES('"+email+"','"+password+"')");
...
<center><h4><P style="color:blue">logged in!!</p></h4>
<center><h4><a href="products.html">click to view products page</a></h4>

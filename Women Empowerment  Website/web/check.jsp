...
<%!
    ...
    public void jspInit()
    {
        try
        {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/techify_db?useTimeZone=true&serverTimezone=UTC&autoReconnect=true&useSSL=false","root","newrootpassword");
            //create statement object
            ps1 = con.prepareStatement("select count(*) from  where username = ? and password=?");
